...
def change(widget, colors):
    '''Update the foreground color of a widget to show the RBG color value
    stored in a dictionary with keys 'red', 'green', and 'blue'. Does *not*
...
# Set up text entry widgets for red, green, and blue, storing the associated
# variables in a dictionary for later use.
colors = {}
